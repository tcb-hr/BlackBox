...
var getLatLong = function(reqBody){
  ...
  request('http://open.mapquestapi.com/geocoding/v1/batch?key=Fmjtd%7Cluub2g6bl1%2Cra%3Do5-9ual56' + '&inFormat=json&json=' + JSON.stringify(locations))
    .then(function(response){
      ...
      console.log('inside pick', pickCoordinates);
      console.log('inside drop', dropCoordinates);
      array.push(pickCoordinates);
      array.push(dropCoordinates);
      return array;
...
exports.twinjet = function (req, res, next) {
  ...
  var itemToAdd; 
  console.log('work', getLatLong(req.body));
