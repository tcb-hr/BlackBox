...
exports.gram = function(req ,res, next){
  var request = require('request-promise');
  // URL for non-batch requests 'http://open.mapquestapi.com/geocoding/v1/address?key=Fmjtd%7Cluub2g6bl1%2Cra%3Do5-9ual56'  
  request('https://api.instagram.com/v1/tags/' + 'testing123' + '/media/recent?client_id=ce171905d26343f4b73d255d2b2f0087')
    .then(function(response){
      console.log('response', response);
      var dbObj = {};
      var resObj = JSON.parse(response);
      dbObj.body = "New Instagram Post!";
      ...
      console.log('item to save', dbObj);
