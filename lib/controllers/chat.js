  ...
  if (req.body.applicable_courier){
    req.body.user = 
      req.body.applicable_courier.courier_number + ' ' + (req.body.applicable_courier.nick_name !== '' 
        ? req.body.applicable_courier.nick_name : req.body.applicable_courier.first_name + ' ' + req.body.applicable_courier.last_name;);
...
var createJobDelivered = function(obj){
  obj.body =  "DEL: " + obj.user + " dropped the " + obj.applicable_job.client_name + " to " + obj.applicable_job.drop_address.street_address;
  return obj;
};
...
var createJobLate = function(obj){
  obj.body = "OVERDUE: " + obj.applicable_job.client_name + " to " + obj.applicable_job.drop_address.street_address + " is overdue";
  return obj;
};
