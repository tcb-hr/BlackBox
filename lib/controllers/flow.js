 ...
 */ (function(window, document, undefined) {
    ...
    function Flow(opts) {
         ...
         */
        this.support = (
        typeof File !== 'undefined' && typeof Blob !== 'undefined' && typeof FileList !== 'undefined' && ( !! Blob.prototype.slice || !! Blob.prototype.webkitSlice || !! Blob.prototype.mozSlice || false) // slicing files support
        );
    ...
    Flow.prototype = {
        ...
        addFiles: function(fileList, event) {
            ...
            each(fileList, function(file) {
                ...
                if (!(file.size % 4096 === 0 && (file.name === '.' || file.fileName === '.')) && !this.getFromUniqueIdentifier(this.generateUniqueIdentifier(file))) {
        ...
        status: function() {
            if (this.pendingRetry) {
                ...
                if (this.xhr.status == 200) {
                    // HTTP 200, perfect
                    return 'success';
                } else if (this.flowObj.opts.permanentErrors.indexOf(this.xhr.status) > -1 || this.retries >= this.flowObj.opts.maxChunkRetries) {
